...
biography = "Hi, I am Chee Yang and I like doing sports such as swimming, playing badminton, playing pickleball, playing basketball and many more"
                    ...
                    data.forEach(s => {
                        container.innerHTML += `
                            <div class="card">
                                ...
                                <div class="info-item"><span class="label">Favourite Color:</span> ${s.color || 'Secret'}</div>
